...
public class MBTIPersonalityTest {
    ...
    String[] extrovertedVsIntroverted = new String[5], extrovertedVsIntrovertedOption = new String[5];
    String[] sensingVsIntuitive = new String[5], sensingVsIntuitiveOption = new String[5];
    String[] thinkingVsFeeling = new String[5], thinkingVsFeelingOption = new String[5];
    String[] judgingVsPerceptive = new String[5], judgingVsPerceptiveOption = new String[5];
    String name;
    int counter = 0, extroverted = 0, introverted = 0, sensing = 0, intuitive = 0, thinking = 0, feeling = 0, judging = 0, perceptive = 0;

    public void mBTiTestDisplay() {
        ...
        while (counter < 19) {
            if (counter == 0) {
                ...
                if (ans.equalsIgnoreCase("a")) {
                    extrovertedVsIntroverted[0] = "A. Expend energy, enjoy groups";
                    counter++;
                    extrovertedVsIntrovertedOption[0] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    extrovertedVsIntroverted[0] = "B. Conserve energy, one-on-one\"";
                    counter++;
                    extrovertedVsIntrovertedOption[0] = ans;
                }
            ...
            if (counter == 1) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    sensingVsIntuitive[0] = "A. Interpret literally.";
                    counter++;
                    sensingVsIntuitiveOption[0] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    sensingVsIntuitive[0] = "B. Look for meaning and possibilities";
                    counter++;
                    sensingVsIntuitiveOption[0] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 2) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    thinkingVsFeeling[0] = "A. Logical, thinking, questioning.";
                    counter++;
                    thinkingVsFeelingOption[0] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    thinkingVsFeeling[0] = "B. Empathetic, feeling, accommodating";
                    counter++;
                    thinkingVsFeelingOption[0] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 3) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    judgingVsPerceptive[0] = "A. Organized, orderly.";
                    counter++;
                    judgingVsPerceptiveOption[0] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    judgingVsPerceptive[0] = "B. Flexible, adaptable";
                    counter++;
                    judgingVsPerceptiveOption[0] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 4) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    extrovertedVsIntroverted[1] = "A. More outgoing, think out loud.";
                    counter++;
                    extrovertedVsIntrovertedOption[1] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    extrovertedVsIntroverted[1] = "B. More reserved, think to yourself.";
                    counter++;
                    extrovertedVsIntrovertedOption[1] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 5) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    sensingVsIntuitive[1] = "A. Practical, realistic, experiential.";
                    counter++;
                    sensingVsIntuitiveOption[1] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    sensingVsIntuitive[1] = "B. Imagination, innovative, theoretical.";
                    counter++;
                    sensingVsIntuitiveOption[1] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 6) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    thinkingVsFeeling[1] = "A. Candid, straight forward, frank.";
                    counter++;
                    thinkingVsFeelingOption[1] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    thinkingVsFeeling[1] = "B. Tactful, kind, encouraging.";
                    counter++;
                    thinkingVsFeelingOption[1] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 7) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    judgingVsPerceptive[1] = "A. Plan, schedule.";
                    counter++;
                    judgingVsPerceptiveOption[1] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    judgingVsPerceptive[1] = "B. Unplanned, spontaneous";
                    counter++;
                    judgingVsPerceptiveOption[1] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 8) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    extrovertedVsIntroverted[2] = "A. seek many tasks, public activities, interaction with others";
                    counter++;
                    extrovertedVsIntrovertedOption[2] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    extrovertedVsIntroverted[2] = "B. seek private, solitary activities with quiet to concentrate.";
                    counter++;
                    extrovertedVsIntrovertedOption[2] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 9) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    sensingVsIntuitive[2] = "A. standard, usual, conventional.";
                    counter++;
                    sensingVsIntuitiveOption[2] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    sensingVsIntuitive[2] = "B. different, novel, unique.";
                    counter++;
                    sensingVsIntuitiveOption[2] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 10) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    thinkingVsFeeling[2] = "A. firm, tend to criticize, hold the line.";
                    counter++;
                    thinkingVsFeelingOption[2] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    thinkingVsFeeling[2] = "B. gentle, tend to appreciate, conciliate.";
                    counter++;
                    thinkingVsFeelingOption[2] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 11) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    judgingVsPerceptive[2] = "A.regulated, structured.";
                    counter++;
                    judgingVsPerceptiveOption[2] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    judgingVsPerceptive[2] = "B. easygoing, live  and let live";
                    counter++;
                    judgingVsPerceptiveOption[2] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 12) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    extrovertedVsIntroverted[3] = "A. external, communicative, express yourself.";
                    counter++;
                    extrovertedVsIntrovertedOption[3] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    extrovertedVsIntroverted[3] = "B. internal, reticent, keep to yourself.";
                    counter++;
                    extrovertedVsIntrovertedOption[3] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 13) {
                System.out.println("1(4) A. focus on here-and-now.       B. look to the future, global perspective, \"big picture\"");
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    sensingVsIntuitive[3] = "A. focus on here-and-now.";
                    counter++;
                    sensingVsIntuitiveOption[3] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    sensingVsIntuitive[3] = "B. look to the future, global perspective, \"big picture\"";
                    counter++;
                    sensingVsIntuitiveOption[3] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 14) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    thinkingVsFeeling[3] = "A. tough minded, just.";
                    counter++;
                    thinkingVsFeelingOption[3] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    thinkingVsFeeling[3] = "B. tender-hearted, merciful";
                    counter++;
                    thinkingVsFeelingOption[3] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 15) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    judgingVsPerceptive[3] = "A. preparation, plan ahead.";
                    counter++;
                    judgingVsPerceptiveOption[3] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    judgingVsPerceptive[3] = "B. go with the flow, adapt as you go.";
                    counter++;
                    judgingVsPerceptiveOption[3] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 16) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    extrovertedVsIntroverted[4] = "A. active, initiate.";
                    counter++;
                    extrovertedVsIntrovertedOption[4] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    extrovertedVsIntroverted[4] = "B. reflective, deliberate";
                    counter++;
                    extrovertedVsIntrovertedOption[4] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 17) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    sensingVsIntuitive[4] = "A. facts, things, \"what is\"";
                    counter++;
                    sensingVsIntuitiveOption[4] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    sensingVsIntuitive[4] = "B. ideas, dreams, 'what could be', philosophical";
                    counter++;
                    sensingVsIntuitiveOption[4] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 18) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    thinkingVsFeeling[4] = "A. matter of fact, issue oriented";
                    counter++;
                    thinkingVsFeelingOption[4] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    thinkingVsFeeling[4] = "B. sensitive, people-oriented, compassionate";
                    counter++;
                    thinkingVsFeelingOption[4] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
            ...
            if (counter == 19) {
                ...
                String ans = input.next();
                if (ans.equalsIgnoreCase("a")) {
                    judgingVsPerceptive[4] = "A. control, govern";
                    counter++;
                    judgingVsPerceptiveOption[4] = ans;
                }
                if (ans.equalsIgnoreCase("b")) {
                    judgingVsPerceptive[4] = "B. latitude, freedom";
                    counter++;
                    judgingVsPerceptiveOption[4] = ans;
                }
                if (!ans.equalsIgnoreCase("a") && !ans.equalsIgnoreCase("b")) {
    ...
    public String setExtrovertedVsIntroverted() {
        ...
        System.out.println("Number Of A Selected Is: " + introverted + "\nNumber OF B Selected Is: " + extroverted);
    ...
    public String setSensingVsIntuitive() {
        System.out.println();
        for (String element : sensingVsIntuitiveOption) {
        ...
        for (String element1 : sensingVsIntuitive) {
            System.out.println(element1);
        }
        System.out.println("Number Of A Selected Is: " + sensing + "\nNumber OF B Selected Is: " + intuitive);
        if (sensing > intuitive) {
            return "S";
        } else return "N";
    }

    public String setThinkingVsFeeling() {
        System.out.println();
        for (String element : thinkingVsFeelingOption) {
            if (element.equalsIgnoreCase("a")) {
                thinking++;
            } else {
                feeling++;
        ...
        for (String element1 : thinkingVsFeeling) {
            System.out.println(element1);
        }
        System.out.println("Number Of A Selected Is: " + thinking + "\nNumber OF B Selected Is: " + feeling);
        if (thinking > feeling) {
            return "T";
        } else return "F";
    }

    public String setJudgingVsPerceptive() {
        System.out.println();
        for (String element : judgingVsPerceptiveOption) {
            if (element.equalsIgnoreCase("a")) {
                judging++;
            } else {
                perceptive++;
        ...
        for (String element1 : judgingVsPerceptive) {
            System.out.println(element1);
        }
        System.out.println("Number Of A Selected Is: " + thinking + "\nNumber OF B Selected Is: " + feeling);
    ...
    public void finalDisplayResult() {
        System.out.println();
        String a = setExtrovertedVsIntroverted();
        String b = setSensingVsIntuitive();
        String c = setThinkingVsFeeling();
        String d = setJudgingVsPerceptive();
        ...
        switch (output) {
            case "ENFJ" -> System.out.println("""
                    ENFJ personalites
                    A ENTJ (ENFJ) is a person with the Extraverted, Intuitive, Feeling, and Judging personality traits. These warm, forthright types love helping others, and they tend to have strong ideas and values. They back their perspective with the creative energy to achieve their desires.
                    ...
                    People with this personality type are devoted altruists, ready to fight for the people and ideas that they believe in. This strength of conviction bolsters ENTJs’ innate leadership skills, particularly their ability to guide people to work together in service of the greater good.""");
